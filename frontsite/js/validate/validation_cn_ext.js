...
/*	
		...
		var advice = '<div class="validation-advice" id="advice-' + ValidationUtils.getElmID(elm) +'" style="display:none">' + errorMsg + '</div>'
		alert(advice);
...
*/		
		var advice = $('advice-' + ValidationUtils.getElmID(elm));
		return advice;
	},
...
//		var advice = Validation.getAdvice(name, elm);
	//	advice.className = 'msg2';
		...
		if(advice) {
			if(typeof Effect == 'undefined')
			{
				//advice.hide() //modify by chenhaifeng
			}
			else 
			{
