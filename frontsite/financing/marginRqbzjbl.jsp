...
<form action="${contextPath }/pledgeAndKeepAction.do?method=getPledgeAndKeepFrontList&nav3=rqbzjbl" id="pledgeAndKeepForm" name="pledgeAndKeepForm" method="post">
...
<div class="wrap_2left">
  ...
  <div class="w210 fleft">
		<jsp:include page="/financing/notice_lmenu.jsp?menu=margin&nav3=rqbzjbl" />
  ...
  <div class="w706 fright">
  		<div class="comtit1"><h4>融券保证金比例</h4></div>
    <div class="blank10"></div>
    <table width="96%" align="center">
   <jsp:include page="/financing/indexTitles.jsp">
           <jsp:param name="whichCat" value="ggxxrqbzjbl"/>
    	</jsp:include>
        				...
        				for (int i = 0; i < quoteList.size() ; i ++)
        				{
        						...
        						%>
        								<tr class="zqpzzslb">
									        ...
									        <td><%if(pledgeQuote.getRqRate()!=null&&pledgeQuote.getRqRate()>0)
												        {
						        							   out.print(mdf.format(pledgeQuote.getRqRate()*100)+"%");
						        						}
									          %></td>
...
<SCRIPT LANGUAGE="JavaScript">
     function  checkStock(){
          ...
          var startDate = document.getElementById("startDate").value;
 		  document.location.href="${contextPath }/pledgeAndKeepAction.do?method=getPledgeAndKeepFrontList&nav3=rqbzjbl&gpdm="+stockId+"&startDate="+startDate;
 	}
 	 function  checkStockQb(){
 		  document.location.href="${contextPath }/pledgeAndKeepAction.do?method=getPledgeAndKeepFrontList&nav3=rqbzjbl";
 	}
</SCRIPT> 
</html>