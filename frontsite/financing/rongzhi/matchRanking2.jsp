...
<body>
	...
	<form action="${contextPath }/adviceAction.do?method=getlistTO" id="yybListForm"  name="yybListForm" method="post">
	    ...
	    <tr>
	      ...
	      <td width="19%" align="left"><input type="submit" name="button" id="button" class="but_01"  value="提交" /></td>
							...
							<ul class="tab-menu">
								...
								<li class="hover"><a href="${contextPath }/adviceAction.do?method=getlistTO">“T+0”排名</a><b></b></li>
								<li><a href="${contextPath }/adviceAction.do?method=getlistETF">“ETF”排名</a><b></b></li>															
							</ul>
							<div class="tab-cont">
      ...
      <tr>
        ...
        <th class="center bold" style="line-height:30px">T+0指标得分</th>
        <th class="center bold" style="line-height:30px">日期</th>
      </tr>
      <c:choose>
      	<c:when test="${t0List!=null }">
      		<c:forEach items="${t0List }" var="t">
      			<tr>
