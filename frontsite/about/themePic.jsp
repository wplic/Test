...
<div class="zttit3">专题图片</div>
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
      	<%for(int j=0;j<5;j++){ 
    	ThemePic pic = (ThemePic)piclist.get(i*5+j);%>
        <td align="center" width="20%">
        	<a href="${ctx}/about/themePicShow.jsp?themeid=<%=themeid%>&picid=<%=pic.getId()%>">
        		<img src="${ctx}/share/showUploadImage.jsp?id=<%=pic.getPicid()%>" class="borimg" width="100" height="90" />
    ...
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
    	<%for(int i=0;i<5;i++){
    		if(i<total%5){
    		ThemePic pic = (ThemePic)piclist.get(row*5+i);%>
	        <td align="center" width="20%">
	        	<a href="${ctx}/about/themePicShow.jsp?themeid=<%=themeid%>&picid=<%=pic.getId()%>">
	        		<img src="${ctx}/share/showUploadImage.jsp?id=<%=pic.getPicid()%>" class="borimg" width="100" height="90"/>
	        		<p class="imgtxt"><%=pic.getTitle() %></p></a>
	        </td>
	        <%}else{ %>
	        <td align="center" width="20%">
	        	&nbsp;
