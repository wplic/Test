...
<table width="95%" align="center"  border="0" cellspacing="0" cellpadding="0" class="lh27 list_bline1">
		<paging:pageRow id="doc" type="com.css.cms.document.Document">
					<%
						...
						String stime=DocumentHelper.getUploadDate(doc ,"yyyy-MM-dd");
						boolean flag=false;
						if(stime!=null&&!stime.equals(""))
						{
						   Date tdate= sdf.parse(stime);
						   long g= ((sdf.parse(sdf.format(new Date())).getTime())-tdate.getTime())/1000/(24*60*60);
						   if(g<14)
						     flag=true;
						}
					%>
					...
					<td >
					<%if(flag){ %>
					<a href="<%=detailPage %>" target="_blank" title="<%=doc.getTitle() %>"><%=DocumentHelper.getTitle(doc,Integer.parseInt(titleWidth))%></a>
					<%}else{
					%>
