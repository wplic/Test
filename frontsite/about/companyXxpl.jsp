...
<div class="main">
  <div class="dqwz">当前位置：<a href="/default.html">首页</a> - <a href="/about/aboutUs.html">关于广发</a>  - 信息披露</div>
</div>
<div class="wrap_2left">
  ...
  <div class="w210 fleft">
				<jsp:include page="/about/about_lmenu.jsp">
		           ...
		           <jsp:param name="nav2" value="xxpl"/>
		    	</jsp:include>
  </div>
  <!--左侧sied结束-->
  ...
  <div class="w706 fright">
    ...
    <div class="blank10"></div>
        <jsp:include page="/about/aboutListGygf.jsp">
           <jsp:param name="whichCat" value="gfzq_xxpl"/>
