...
<div class="zttit3">专题简介</div>
    <div class="block9"></div>
	<div class="tlbg3">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td colspan="2" class="bold font16 pt7 pb5" align="center">
        	<p class="textTitle1" align="center"><%=null==theme?"":theme.getTitle() %></p>
        </td>
      </tr>
      <tr>
        <td colspan="2">
      ...
      <tr>
        ...
        <td align="center">
        	<%=sdf.format(themeIntro.getUpdatetime()) %>
        </td>
      </tr>
    </table>
    </div>
