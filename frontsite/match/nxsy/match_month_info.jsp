...
<body>
	<form name="searchForm" id="searchForm"	action="${contextPath}/nxsy/web/NxsyQueryMaAction.go?function=ListMonthInfo" method="post">
		<script>
											...
											<c:when test="${not empty page.data}">
												<c:forEach var="item" varStatus="status" items="${page.data}">
													<tr align="center" class="odd blue">
														...
														<td align="center">&nbsp;  <f:formatNumber value="${item.profitrate_month}" type="number" pattern="0.00%"/></td>
														<td align="center">&nbsp; <c:out
