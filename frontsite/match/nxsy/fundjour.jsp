...
<body>
	<form name="searchForm" id="searchForm"	action="/nxsyQueryHisAction.do?method=listFundjour" method="post">
		<script>
											...
											<c:when test="${not empty page.data}">
												<c:forEach var="item" items="${page.data}">
													<tr align="center" class="odd blue">
														...
														<td align="center">&nbsp; <c:out
																value="${item.occur_balance}" /></td>
														<td align="center">&nbsp; <c:out
																value="${item.post_balance}" /></td>
							                            <td align="center" >&nbsp;
