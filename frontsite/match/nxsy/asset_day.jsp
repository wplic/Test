...
<body>
	<form name="searchForm" id="searchForm"	action="/nxsyAssetAction.do?method=listAssetDay" method="post">
		<script>
								...
								<table class="content">
									<tbody>
										...
										<c:choose>
											<c:when test="${not empty page.data}">
												<c:forEach var="item" items="${page.data}">
													<tr align="center" class="odd blue">
														...
														<td align="center">&nbsp; <c:out
																value="${item.fund_balance}" /></td>
														<td align="center">&nbsp; <c:out
																value="${item.market_value}" /></td>
														<td align="center">&nbsp; <c:out
																value="${item.asset}" /></td>														
														<td align="center">&nbsp; <c:out
																value="${item.profit}" /></td>
													</tr>
												</c:forEach>
												...
												<tr height="25">
													<td colspan="6" align="right" bgcolor="#FFFFFF"><c:out
											...
											<c:otherwise>
												<tr>
													<td colspan="6" bgcolor="#FFFFFF">暂无数据</td>
												</tr>
											</c:otherwise>
										</c:choose>
									</tbody>
