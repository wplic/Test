						...
						<c:forEach var="item" items="${page2}" varStatus="index">
								<table width="100%" border="0" cellspacing="0" style="margin-bottom:1px;">
								  <tr>
									...
									<table  border="0" cellpadding="0" cellspacing="0"  style=" background-color:green;height:8px;  width:${tablewidth}px; "><tr><td>
									
										
							
									</td></tr></table>
									</td>
									<td width="45" align="right"><div  style="color:blue; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" onclick="radio_click(1001,${item.remain_amount},${item.entrust_price},1)" ext:qtip="转出${5-index.index}比例<br/>单击：自动填充转换比例">${item.remain_amount/1000}</div></td>
								  </tr>
							  	</table>
			  			</c:forEach>
						</c:when>
		    ...
		    <td height="21" class="tablebtl">
					<table  width="100%" border="0" cellspacing="0">
					  <tr>
						...
						<td width="41"><div  style="color:red; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" ext:qtip="最新比例<br/>单击：自动填充转换比例" onclick="radio_click(1001,1000,$d('inp_entrust_deliver_price_Rose').value,1)"><f:formatNumber value="${data2.entrust_deliver_price_Rose }" pattern="#,##0.000#" /></div></td>
						<td width="50" style="font-size: 12px">最新净值</td>
						<td width="41" ><div  style="color:red; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" ext:qtip="最新净值比例<br/>单击：自动填充转换比例" onclick="radio_click(1001,1000,$d('inp_entrust_net_price_Rose').value,1)"><f:formatNumber value="${data2.entrust_net_price_Rose }" pattern="#,##0.000#" /></div></td>
						<td width="30" style="font-size: 12px">涨幅</td>
						<td width="60" ><div  style="color:red; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" ext:qtip="涨幅比例<br/>单击：自动填充转换比例" onclick="radio_click(1001,1000,$d('inp_entrust_deliver_price_Rose').value,1)"><f:formatNumber type="number" value="${data2.increase_amount_Rose*100 }" maxFractionDigits="3"/>%</div></td>
					  </tr>
					</table>
						...
						<c:when test="${not empty page1}">
							...
							<table width="100%" border="0" cellspacing="0" style="margin-bottom:1px;">
							  <tr>
								...
								<td width="43" align="right" height="16px"><div  style="color:red;height:14px; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" onclick="radio_click(1001,${item.remain_amount},${item.entrust_price},2)" ext:qtip="转入${index.index+1}比例<br/>单击：自动填充转换比例"><f:formatNumber value="${item.entrust_price }" pattern="#,##0.000#" /></div></td>
								<td width="102" align="right">
								<c:if test="${(101.1/data2.maxamount*item.remain_amount/1000)>0 and (101.1/data2.maxamount*item.remain_amount/1000)<1}">
									<c:set var="tablewidth" value="1"/>
									</c:if>
								...
								<td width="45" align="right"><div  style="color:blue; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" onclick="radio_click(1001,${item.remain_amount},${item.entrust_price},2)" ext:qtip="转出${index.index+1}比例<br/>单击：自动填充转换比例">${item.remain_amount/1000}</div></td>
							  </tr>
						  	</table>
						  	</c:forEach>
		    ...
		    <td height="28" class="tablebtl">
			  <table width="100%" border="0" cellspacing="0">
					  ...
					  <input type="hidden" id="inp_max_entrust_price_Rose" value="${data2.max_entrust_price_Rose}"></input>	
						...
						<td width="43" align="center" ><div  style="width:100px; color:red;font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" ext:qtip="上限比例<br/>单击：自动填充转换比例" onclick="radio_click(1001,1000,$d('inp_max_entrust_price_Rose').value,1)">${data2.max_entrust_price_Rose }</div></td>
						<td width="85" style="font-size: 12px">下限</td>
						<td width="43" width="112" align="center" ><div  style="width:100px;color:green;font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" ext:qtip="下限比例<br/>单击：自动填充转换比例" onclick="radio_click(1001,1000,$d('inp_min_entrust_price_Rose').value,1)">${data2.min_entrust_price_Rose }</div></td>
					  </tr>
			  </table>
...
<div id="sell_1002" style="float:left; width:265; font-size: 12px">
		<table width="265" height="144" border="0.1" cellpadding="0" cellspacing="0" bordercolor="#8DB2E3" style="font-size: 12px" class="tablebbr">
						...
						<c:when test="${not empty page4}">
							...
							<table width="100%" border="0" cellspacing="0" style="margin-bottom:1px;">
							  <tr>
								...
								<td width="45" align="right"><div  style="color:blue; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" onclick="radio_click(1002,${item.remain_amount},${item.entrust_price},1)" ext:qtip="转出${5-index.index}比例<br/>单击：自动填充转换比例">${item.remain_amount/1000}</div></td>
							  </tr>
						  	</table>
						  	</c:forEach>
		  ...
		  <tr>
		    <td height="21" class="tablebtl">
		   			 <c:set var="pass_entrust_net_price_Drop" value="${(data2.max_entrust_price_Drop+data2.min_entrust_price_Drop)/2}" ></c:set>
					<c:set var="increase_amount_drop" value="${(data2.entrust_net_price_Drop-pass_entrust_net_price_Drop)/pass_entrust_net_price_Drop*100}"></c:set>
					<table  width="100%" border="0" cellspacing="0">
					  <tr>
					  ...
					  <input type="hidden" id="inp_entrust_net_price_Drop" value="${data2.entrust_net_price_Drop}"></input>											
						<td width="29" height="17" style="font-size: 12px">最新</td>
						<td width="41"><div  style="color:red; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" ext:qtip="最新比例<br/>单击：自动填充转换比例" onclick="radio_click(1002,1000,$d('inp_entrust_deliver_price_Drop').value,1)"><f:formatNumber value="${data2.entrust_deliver_price_Drop }" pattern="#,##0.000#" /></div></td>
						<td width="50" style="font-size: 12px">最新净值</td>
						<td width="41" ><div  style="color:red; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" ext:qtip="最新净值比例<br/>单击：自动填充转换比例" onclick="radio_click(1002,1000,$d('inp_entrust_net_price_Drop').value,1)"><f:formatNumber value="${data2.entrust_net_price_Drop }" pattern="#,##0.000#" /></div></td>
						<td width="30" style="font-size: 12px">涨幅</td>
						<td width="60" ><div  style="color:red; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" ext:qtip="涨幅比例<br/>单击：自动填充转换比例" onclick="radio_click(1002,1000,$d('inp_entrust_deliver_price_Drop').value,1)"><f:formatNumber type="number" value="${data2.increase_amount_Drop*100 }" maxFractionDigits="3"/>%</div></td>
					  </tr>
					</table>
		  ...
		  <tr>
		   ...
		   <c:choose>
				...
				<table width="100%" border="0" cellspacing="0" style="margin-bottom:1px;">
				  <tr>
					<td width="38" style="font-size: 12px" >转入${fn:substring("1一2二3三4四5五",fn:indexOf("1一2二3三4四5五",index.index+1)+1 , fn:indexOf("1一2二3三4四5五",index.index+1)+2)}</td>
					<td width="43" align="right" height="16px"><div  style="color:red; height:14px; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" onclick="radio_click(1002,${item.remain_amount},${item.entrust_price},2)" ext:qtip="转入${1+index.index}比例<br/>单击：自动填充转换比例"><f:formatNumber value="${item.entrust_price }" pattern="#,##0.000#" /></div></td>
					<td width="102" align="right">
					<c:if test="${(101.1/data2.maxamount*item.remain_amount/1000)>0 and (101.1/data2.maxamount*item.remain_amount/1000)<1}">
									<c:set var="tablewidth" value="1"/>
									</c:if>
					...
					<td width="45" align="right"><div  style="color:blue; font-size: 12px" onMouseOver="this.className='onover'"   onMouseOut="this.className=''" onclick="radio_click(1002,${item.remain_amount},${item.entrust_price},2)" ext:qtip="转入${1+index.index}比例<br/>单击：自动填充转换比例">${item.remain_amount/1000}</div></td>
				  </tr>
			  	</table>
			  	</c:forEach>
		    ...
		    <td height="28" class="tablebtl">
			  <table width="100%" border="0" cellspacing="0">
					  ...
					  <input type="hidden" id="inp_max_entrust_price_Drop" value="${data2.max_entrust_price_Drop}"></input>	
						...
						<td width="49" style="font-size: 12px">上限</td>
						<td width="43" align="center" ><div  style="color:red;font-size: 12px" onMouseOver="this.className='onover'" ext:qtip="上限比例<br/>单击：自动填充转换比例" onclick="radio_click(1002,1000,$d('inp_max_entrust_price_Drop').value,1)"  onMouseOut="this.className=''" >${data2.max_entrust_price_Drop }</div></td>
						<td width="85" style="font-size: 12px">下限</td>
						<td width="43"  align="center" ><div  style="color:green;font-size: 12px" onMouseOver="this.className='onover'" ext:qtip="下限比例<br/>单击：自动填充转换比例" onclick="radio_click(1002,1000,$d('inp_min_entrust_price_Drop').value,1)"   onMouseOut="this.className=''" >${data2.min_entrust_price_Drop }</div></td>
					  </tr>
			  </table>
