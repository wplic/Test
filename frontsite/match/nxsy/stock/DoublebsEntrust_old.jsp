...
<div class="content1">
	...
	<div class="overTable" id="sell_1001">
		<table class="content " >
						...
						<c:when test="${not empty page2}">
							<c:forEach var="item" items="${page2}">
								<tr align="center" class="odd blue">
									<td>
										<input type="radio" name="sradio_1001_in"
											value="${item.stock_code}"
											onclick="radio_click(1001,${item.remain_amount},${item.entrust_price},'in','sradio_1001_in')">
									</td>
									<td align="center">									
					...
					<c:choose>
						<c:when test="${not empty page1}">
							<c:forEach var="item" items="${page1}">
								...
								<tr align="center" class="odd blue">
									<td>
										<input type="radio" name="sradio_1001_out"
											value="${item.stock_code}"
											onclick="radio_click(1001,${item.remain_amount},${item.entrust_price}, 'out','sradio_1001_out')">
									</td>
									<td align="center">									
										&nbsp;<f:formatNumber value="${item.remain_amount }" pattern="#,##0" />
									</td>
					...
					<c:choose>
						<c:when test="${not empty page4}">
							<c:forEach var="item" items="${page4}">
								...
								<tr align="center" class="odd blue">
									<td>
										<input type="radio" name="sradio_1002_in" value="${item.stock_code}"
											onclick="radio_click(1002,${item.remain_amount},${item.entrust_price},'in','sradio_1002_in')">
									</td>
									<td align="center">									
										&nbsp;<f:formatNumber value="${item.remain_amount }" pattern="#,##0" />
									</td>
					...
					<c:choose>
						<c:when test="${not empty page3}">
							<c:forEach var="item" items="${page3}">
								...
								<tr align="center" class="odd blue">
									<td>
										<input type="radio" name="sradio_1002_out" value="${item.stock_code}"
											onclick="radio_click(1002,${item.remain_amount},${item.entrust_price},'out','sradio_1002_out')">
									</td>
									<td align="center">									
										&nbsp;<f:formatNumber value="${item.remain_amount }" pattern="#,##0" />
									</td>
