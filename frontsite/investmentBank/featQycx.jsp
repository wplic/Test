...
<%
	...
	map2.put("type","2");
	map2.put("sortName", "code");
	map2.put("dir", "asc");
	List list2 = service.selectAll(map2);

%>
<body>
<br /><br /><jsp:include page="/commons/mstop.jsp" />
<div class="main">
  <div class="dqwz">当前位置：<a href="/default.html">首页</a> - <a href="/investmentBank/index.html">投资银行</a> - <a href="/investmentBank/feat.html"> 辉煌业绩</a> - 中小企业承销</div>
</div>
<div class="wrap_2left">
  ...
  <div class="w706 fright">
    ...
    <div class="qycxInfo">
    	<div class="txt">公司一直关注中小企业的发展，对中小企业的长期跟踪研究、适时战略引导业已成为公司投资银行业务的经典特色。 </div>
    </div>
    <div class="blank10"></div>
    <table width="98%" align="center" class="lh24 mt10">
      <tr>
        <td><span class="red font_st font12 ">·</span><span class="font14 bold font_43">广发证券保荐的中小企业板上市公司</span>&nbsp;  ..............................................................................................................................................</td>
      </tr>
    </table>
    ...
    <div class="bg_f5 p8">
    	...
    	<table width="97%" align="center" border="0">
	    	...
	    	for(int j=0;j<list2.size();j++){
	    		sell = (EnterpriseSell)list2.get(j);
    		%>
          	<td width="163" align="center"> <img src="${ctx}/share/showUploadImage.jsp?id=<%=sell.getPicId()%>" width="72" height="56"/>
          	<h4><%=sell.getName() %>(<%=sell.getCode() %>)</h4></td>
	    	...
	    	for(int i=0;i<4-list2.size()%4;i++){
	    		%>
	    		<td width="163" align="center">&nbsp;</td>
	    		 <%
	    	}
