...
<%
   ...
   //取多少条记录
    ...
    String zt = "";
	if (request.getParameter("zt") != null && !"".equals(request.getParameter("zt")))
	{
	...
	Vipgazx vipgazx=vipgazxService.getCstmBgnrbMap(guid);
%>       
...
<div class="main">
   ...
   <p class="textTitle1" align="center"><%=zt %></p>
   <p class="textTitle2" align="center">信息来源：港澳资讯 </p>
   <div class="newstextArea">
   <p class="newstextAreatop"></p>
   <div style="word-wrap:break-word;">
                           <%  
								String content=new String(vipgazx.getNr(), "GBK");
