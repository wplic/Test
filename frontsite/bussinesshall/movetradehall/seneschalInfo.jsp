...
<div class="wrap_2left">
  ...
  <div class="iptvside_mid">
      ...
      <tr>
        <td class="wdlc_ltag1 white" id="hor1" onclick="selectlMenu('hor1','board1')">
        ...
        <td class="font_st welc_subtxt">
        	<p><a href="#" onclick="showDv('4');"><span id="sp4">+</span>广发研究</a></p>
        	    <div id="dv4" style="display:none" style="padding-left:10px">
        	    	 ...
        	    	 <p><a href="#" onclick="gotoIfrm('zqyj_gfyj_qh','广发期货日报','4');" >·广发期货日报</a></p>
        	    	 <p><a href="#" onclick="gotoIfrm('zqyj_gfyj_qhzb','广发期货周报','4');" >·广发期货周报</a></p>
     ...
     <a href="#" onclick="gotoIfrm('blcj_nbzx_zgsxcj','中国首席财经');">博览财经</a></td>
    
      </tr>
      <tr id="board6"  style="display:none">
        <td class="font_st welc_subtxt">
           
           <p><a href="#" onclick="resetCartName('blcj_nbzx_zgsxcj','中国首席财经');">·中国首席财经</a></p>
            <p><a href="#" onclick="resetCartName('blcj_nbzx_sxzqcc','首席证券内参');">·首席证券内参</a></p>
            <p><a href="#" onclick="resetCartName('blcj_nbzx_gcjcck','高层决策参考');">·高层决策参考</a></p>
            <p><a href="#" onclick="resetCartName('blcj_nbzx_cyb','创业板');">·创业板</a></p>
  ...
  <div class="w706 fright">
    <div class="left_tit2">国内财经</div>
	<jsp:include page="newsListSeneschalMain.jsp">
    ...
    <jsp:include page="newsListSeneschalMains.jsp">
            <jsp:param name="catName" value="国内财经" />
            <jsp:param name="whichCat" value="zxzx_glcj"/>
            <jsp:param name="state" value="1"/>
            <jsp:param name="showSize" value="15"/>
    </jsp:include>
  </div>
   <!--右侧sied结束--> 
