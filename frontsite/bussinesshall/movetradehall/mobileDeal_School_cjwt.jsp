...
<table width="93%" class="mt10" align="center">
  ...
  <div class="w706 fright">
    ...
    <img src="/pic/wsyyt/mobileDeal/mobile_ban3.jpg" /></a></p><br />
     <table width="100%">
  		<tr>
  			<td  align="right">
   <iframe id="ifm" name="" src="${ctx }/bussinesshall/movetradehall/schoolQueryNewsList.jsp?state=1&whichCat=wsyyt_zqxx_cjwt&is_delete=0"   frameborder="0" marginheight="0" marginwidth="0"  width="96%" scrolling="no">
                   </iframe>
	</td>
  		</tr>
  </table>	
