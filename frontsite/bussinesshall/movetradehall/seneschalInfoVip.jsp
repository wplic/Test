...
<%
  String carName="公司研究";
  String whichCat="01";
  if(request.getAttribute("whichCat")!=null&&!request.getAttribute("whichCat").equals(""))
  whichCat=(String)request.getAttribute("whichCat");
  if(whichCat.equals("01")){
   carName="公司研究";
  }else if(whichCat.equals("02")){
    carName="行业研究";
  }else if(whichCat.equals("03")){
    carName="策略研究";
  }else if(whichCat.equals("04")){
    carName="股票市场";
  }else if(whichCat.equals("05")){
    carName="基金市场";
  }else if(whichCat.equals("06")){
    carName="债券市场";
  }else if(whichCat.equals("07")){
    carName="金融工程";
  }else if(whichCat.equals("08")){
    carName="宏观研究";
  }else if(whichCat.equals("09")){
    carName="专题研究";
  }
%>
<body class="body_bg">
<script type="text/javascript">
		document.getElementById('board3').style.display = "";
		document.getElementById('hor3').className = "wdlc_ltag1 white";
</script>
...
<div class="wrap_2left">
  ...
  <div class="iptvside_bot"></div>
  	<table width="100%" cellpadding="0" cellspacing="5" border="0">
  		<tr>
        <td align="center"><a href="http://get.adobe.com/cn/reader/"><img src="/pic/wsyyt/wdlc/downpdf.jpg" /></a></td>
      </tr>
    </table>
  </div>
  <!--左侧sied结束-->
  ...
  <div class="w706 fright">
    ...
    <div class=" bg_ec mt5" style=" height:60px;">
     ...
     <form action="${ctx }/vip.do?method=getJrsjGazxList&whichCat=${whichCat }" name="jrsjFrom" method="post">
