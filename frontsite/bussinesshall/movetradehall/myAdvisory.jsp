...
<%
	...
	%>
		...
		window.location.href="${ctx}/front/finance.do?method=selectAllFinanceQuestion&category=1&webuser_id=1&is_answer=1";
		</script>
	<%
	}else{
...
<script type="text/javascript">
		...
		function getFinanceQuestion(query){
			var url = "${ctx}/front/finance.do?method=selectAllFinanceQuestion&category=1";
			if(query!=""){
				url=url+query;
			}
			location.href=url;
...
<input type="text" name="EndDate" id="EndDate" onfocus="this.blur()" value="" style="width:86px; border:1px solid #c3c3c3;" ><a href="javascript:void(0)" onClick="gfPop.fEndPop(document.query.StartDate,document.query.EndDate);return false;" HIDEFOCUS><img src="${ctx}/pic/share/selectTime.gif" name="popcal" width="19" height="18" border="0" align="absmiddle"></a>      </tr>
  ...
  <div class="w706 fright">
    <div class="right_tit2 red bold">业务咨询</div>
    ...
    <tr>
      ...
      <td width="15%"><input type="button" name="button" id="button" value="我的未回复" class="but_02" onclick="getFinanceQuestion('&webuser_id=1&is_answer=0');"/></td>
        <td width="15%"></td>
         <td width="38%"></td>
      <td width="17%"><input type="button" name="button5" id="button5" value="我要咨询" onclick="location.href='/bussinesshall/movetradehall/myAdvisory_zx.jsp'" class="but_04" /></td>
      </tr>
    </table>
    </div>
...
<script type="text/javascript"> 
var _aq = _aq || [];
_aq.push(['_setSiteId', 10001]);_aq.push(['_setCatalogId', 33]); _aq.push(['_trackPageview']); (function() {
