...
<%
	...
	<script type="text/javascript">
		alert("提交成功");
		window.location.href="${ctx}/front/finance.do?method=selectAllFinanceQuestion&category=3&webuser_id=1&is_answer=0";
	</script>
	<%
 ...
 <script type="text/javascript">
 	...
 	function  ggcxListCrm(){
 		  ...
 		  var url="${ctx}/front/finance.do?method=selectFQListByAnswer&category=3&webuser_id=1";
 		  if(StartDate!="")
 		  {
...
<div class="wrap_2left">
  ...
  <div class="iptvside_mid">
    <table width="189" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
      ...
      <tr>
        <td class="wdlc_ltag1 white"><a href="/bussinesshall/movetradehall/myJsAdvisory.jsp">技术支持</a></td>
      </tr>
      <tr>
  ...
  <div class="w706 fright">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="wdzx_tit1 red bold">我要咨询</td>
      </tr>
    </table>
    <table width="100%" border="1" bordercolor="#cfcfcf" cellpadding="0" cellspacing="0" align="center" bgcolor="#eceff4" class="lh28">
      <tr>
        <td width="480" class="ptb13" valign="top">
         <form action="${ctx}/front/finance.do?method=addQuestion&category=3&webuser_id=1" method="post" onsubmit="return check();">
        <table width="90%" align="center" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td>&nbsp;</td>
            <td>选择问题类型：
              <input name="type_js" type="radio" id="radio" value="1" checked="checked" />
网上交易
<input name="type_js" type="radio" id="radio2" value="2" />
移动证券</td>
          </tr>
          <tr>
          ...
          <table width="90%" style="border-collapse:collapse" border="1" bgcolor="#ffffff" bordercolor="#cfcfcf" class="lh27 mt6" align="center">
            <tr>
              <td width="94%" class="wdzx_th indent10 bold">&nbsp;</td>
            </tr>
            <tr>
              <td style="padding:5px"><textarea name="ask_content" id="ask_content" cols="45" rows="11" style=" width:420px; border:0" onclick="ask_contentClear()">请不要超过500字！</textarea></td>
            </tr>
          </table>
  ...
  <tr>
    <td width="94%" class="wdzx_th indent10 bold">技术支持查询</td>
  </tr>
  <tr>
...
<input type="text" name="EndDate" id="EndDate" onfocus="this.blur()" value="" style="width:86px; border:1px solid #c3c3c3;" ><a href="javascript:void(0)" onClick="gfPop.fEndPop(document.query.StartDate,document.query.EndDate);return false;" HIDEFOCUS><img src="${ctx}/pic/share/selectTime.gif" name="popcal" width="19" height="18" border="0" align="absmiddle"></a>      </tr>
      <tr>
        ...
        <td><select name="wtlx" id="wtlx">
          ...
          <option value="1">--网上交易--</option>
          <option value="2">--移动证券--</option>
          </select></td>
      </tr>
      <tr>
      <td>关键字:</td>
