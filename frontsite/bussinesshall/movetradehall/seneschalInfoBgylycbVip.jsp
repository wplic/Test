...
<%@page import="com.cssweb.gazx.jrsj.service.BgylycbService"%>
...
<%
	...
	//取营业部的信息  如财富汇
	BgylycbService bgylycbService=(BgylycbService)ctx.getBean("bgylycbService");
%>
<head>
...
<div class="wrap_2left">
             	...
             	<div id="dv3" style="display:none" style="padding-left:10px">
        	    	 ...
        	    	 <p><a href="#"  onclick="showDv('31');"><span id="sp31">+</span>基金投资内参</a></p>
        	    	 	<div id="dv31" style="display:none" style="padding-left:15px">
        	    	 		...
        	    	 		<p><a href="#" onclick="resetCartName('2','nbzx_dp','年报点评','dv31');">·年报点评</a></p>
  ...
  <div class="w706 fright">
    <div class="right_tit2 red bold"><%=carName %></div>
     <form action="${ctx }/vip.do?method=getJrsjBgylycbList" name="jrsjFrom" method="post">
