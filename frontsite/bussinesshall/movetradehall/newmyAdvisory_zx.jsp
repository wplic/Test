...
<%
	...
	<script type="text/javascript">
		alert("提交成功");
		window.location.href="${ctx}/front/finance.do?method=selectAllFinanceQuestion&category=5&webuser_id=1&is_answer=0";
	</script>
	<%
...
<div class="wrap_2left">
  ...
  <div class="w706 fright">
    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td class="wdzx_tit1 red bold">反洗钱咨询</td>
      </tr>
    </table>
    <table width="100%" border="1" bordercolor="#cfcfcf" cellpadding="0" cellspacing="0" align="center" bgcolor="#eceff4" class="lh28">
      <tr>
        ...
        <form action="${ctx}/front/finance.do?method=addQuestion&category=5" method="post" onsubmit="return check();">
  ...
  <tr>
    <td width="94%" class="wdzx_th indent10 bold">反洗钱咨询查询</td>
  </tr>
  <tr>
