...
<html>
	...
	<body>
		<form id="fomr3" action="${ctx }/sz/init_sz.do?method=initInfoCenter"
			method="post">
			<input type="hidden" value="3" name="input_" />
			<table class="tb_" border="0" cellspacing="0" cellpadding="0"
				style="margin-top: 0px; margin-left: 0px;" bordercolor="#cccccc"
				width="100%" align="center">
				<c:if test="${infoCenter_yingyedt!=null}">
				<logic:iterate id="data" name="infoCenter_yingyedt" scope="session"
					indexId="indexid">
					<tr align="center">
