...
<html>
	...
	<body>
		<form id="form2" action="${ctx }/sz/init_sz.do?method=initInfoGncj"
			method="post">
			<input type="hidden" value="2" name="input_" />
			<table border="0" cellspacing="0" cellpadding="0"
				style="margin-top: 0px; margin-left: 0px;" bordercolor="#cccccc"
				width="100%" align="center">
				<c:if test="${infoCenter_gncj!=null}">
				<logic:iterate id="data" name="infoCenter_gncj" scope="session"
					indexId="indexid">
					<tr align="center">
