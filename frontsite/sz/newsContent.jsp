...
<body class="body_bg">
<jsp:include page="${ctx}/sz/top.jsp" />
<div class="main">
  <div class="dqwz"></div>
...
<div id="bottom_bg">
				<div class="bottomfont">
					[ICP 备案登记证编号：粤ICP备11070729号] 广发证券股份有限公司版权所有 Copyright © 2000-2012
					All Rights Reserved.
				</div>
				<div class="btm_web">
					<img src="${contextPath }/images/branchcomp/depend_wet.jpg"
						width="128" height="47" style="float: right;" />
					<img src="${ctx}/images/branchcomp/police.jpg" width="39"
						height="47" style="float: left;"/>
				</div>
			</div>
</body>
</html>
