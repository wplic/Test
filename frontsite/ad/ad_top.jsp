...
<%
	...
	List adFlashList = adMangerService.getAdListBySubAdCode("ad_top_f");
	...
	//flash 存在
	 ...
	 StringBuffer buffer = new StringBuffer();
		...
		%>
		<jsp:include page="ad_pic_top.jsp">
			  <jsp:param name="widths" value="512"/>
			  <jsp:param name="heights" value="53"/>
			  <jsp:param name="subAdCode" value="ad_top_t"/>
		</jsp:include>
		<%
	}
%>
