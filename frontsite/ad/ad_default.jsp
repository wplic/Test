...
<%
	...
	List adFlashList = adMangerService.getAdListBySubAdCode("ad_default_f");
	int width=492;
	 ...
	 String subAdCode="ad_default_t";
	 if(request.getParameter("subAdCode")!=null&&!request.getParameter("subAdCode").equals(""))
	     subAdCode=request.getParameter("subAdCode");
	...
	//flash 存在
	 ...
	 StringBuffer buffer = new StringBuffer();
		...
		%>
		<jsp:include page="/ad/ad_default_pic.jsp">
			  <jsp:param name="widths" value="<%=width %>"/>
			  <jsp:param name="heights" value="<%=height %>"/>
			  <jsp:param name="subAdCode" value="<%=subAdCode %>"/>
		</jsp:include>
		<%
	}
%>
