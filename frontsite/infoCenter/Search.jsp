...
<table width="95%" style="border-collapse:collapse" border="1" bgcolor="#ffffff" bordercolor="#cfcfcf" class="lh21 mt5" align="center">
  <tr>
    <td width="94%" class="info_th01" style=" border-bottom:0">资讯检索</td>
  </tr>
  <tr>
    <td style="padding:5px">
<form action="${ctx}/infoCenter/QueryNewsList.jsp" name="query" method="post" onsubmit="checkSearch();return false;">
  <table width="100%" class="font_43">
      ...
      <tr>
        ...
        <select name="whichCat">
              	<option value="zxzx|zqyj|tzzyd">请选择栏目</option>
      ...
      <tr>
        <td>关键字：</td>
        <td>
        <input name="keyword" type="text" class="input108" size="10">
        </td>
      </tr>
      <tr>
