...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt;  <a href="${contextPath }/infoCenter/index.jsp?nav=zxzx">资讯中心</a> &gt; <a href="${contextPath }/infoCenter/stock.jsp?nav=zxzx&nav1=gp&nav2=gsyw&nav2=gsyw&whichCat=zxzx_gp_gsyw"> 股票 </a> &gt; <%=displayName %></div>
</div>
