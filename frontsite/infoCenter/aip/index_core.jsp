...
<style type="text/css" >
<!--
#stk_div_list { color:#00f; font:Arial, Helvetica, sans-serif; font-size:12px; position:absolute;display:none;width:140px; height:auto;z-index:1000;background:#fff;padding:0;border:1px solid #C62121; }
			...
			<div class="w706 fright">
				...
				<div class="schemebody" >
					<form name="aipForm" id="aipForm"
						action="/fundAIPAction.do?method=list&type=2" method="post">
