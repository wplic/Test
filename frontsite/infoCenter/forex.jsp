...
%>
<body class="body_bg">
<jsp:include page="/share/top.jsp?nav=zxzx&nav1=wh" />
<div class="wjdc_box">
  <p class="wjdc"><a href="/investorEdu/investorSurvey.html"><img src="/pic/index/wzdc.jpg"/></a></p>
</div>
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt; <a  href="/infoCenter/index.jsp?nav=zxzx"> 资讯中心 </a> &gt;  外汇</div>
</div>
<div class="wrap_2left">
  ...
  <div class="iptvside_mid">
	  		<jsp:include page="/infoCenter/forex_lmenu.jsp">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="236" valign="top" class="bg_ec"><div class="blank5"></div>
             <jsp:include page="/infoCenter/whpj.jsp"/>
        </td>
      </tr>
    </table>
  </div>
