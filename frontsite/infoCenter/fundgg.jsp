...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index"> 首页 </a> &gt;<a href="${contextPath }/infoCenter/fund.jsp?nav=zxzx&nav1=jj&nav2=ggxl"> 基金</a> &gt;  基金公告</div>
</div>
...
<jsp:include page="/infoCenter/Search.jsp"/>
  ...
  <div class="w706 fright">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top">
        	<iframe width="100%"  src="${contextPath}/infoCenter/stockList.jsp?whichCat=zxzx_jj_jjgg&showSize=16" frameborder="0" scrolling="no"" marginheight="0" marginwidth="0" id="fundNews" name="fundNews" height="500" ></iframe>
        	
        </td>
        <td width="236" valign="top" class="bg_ec">
        	<jsp:include flush="true" page="/infoCenter/fundyjsgg.jsp"></jsp:include>
    			<div class="blank5"></div>
