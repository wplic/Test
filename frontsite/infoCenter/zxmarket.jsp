...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt; <a  href="/infoCenter/index.jsp?nav=zxzx"> 资讯中心 </a> &gt; <a href="${contextPath }/infoCenter/zxmarket.jsp?nav=zxzx&nav1=zxb&nav2=zxbxw&whichCat=zxzx_zxb_zxbxw"> 中小板 </a> &gt; <%=displayName %></div>
</div>
<div class="wrap_2left">
  ...
  <div class="iptvside_mid">
	  <jsp:include page="/infoCenter/zxmarket_lmenu.jsp" />
  ...
  <div class="w706 fright">
    ...
    <div class="blank10"></div>
     <jsp:include flush="true" page="/infoCenter/stockTop.jsp">
	          ...
	          <jsp:param name="imgUrl" value="/pic/infoCenter/gsyw05.jpg"/>
	 </jsp:include>
    <div class="blank10"></div>
