...
<div class="wrap_2left">
  ...
  <div class="iptvside_mid">
	  <jsp:include page="${contextPath}/infoCenter/fund_lmenu.jsp?menu1=hor1&menu2=board1&menu3=gfrgjjylb" />
  </div>
 <div class="iptvside_bot"></div>
  ...
  <div class="left_tit2">基金公司列表</div>
    ...
    <table border="1" class="lh24 center" bordercolor="#cccccc" width="100%" id="tabs11">
      <tr>
        <td width="16%" class="tab_th1 bold">基金名称 </td>
        <td width="10%" class="tab_th1 bold">认购代码 </td>
        <td width="8%" class="tab_th1 bold">类型 </td>
        <td width="5%" class="tab_th1 bold">风险 </td>
        <td width="17%" class="tab_th1 bold">认购期 </td>
        <td width="10%" class="tab_th1 bold">收费方式 </td>
        <td width="22%" class="tab_th1 bold">发行公司</td>
        <td width="12%" class="tab_th1 bold">基金经理</td>
      </tr>
      <%
      				...
      				for (int i = 0; i < list.size(); i ++)
      				{
      					...
      					%>
      						<tr>
						        ...
						        <td>
						        <%=jjylb.getShkssjks()>0?jjylb.getShkssjks()+"-":"" %>
						        <%=jjylb.getShkssj()>0?jjylb.getShkssj():"" %></td>
						        <td><%=jjylb.getChargeType()  %></td>
      					...
      					else
      					{
      						...
      						<tr class="bg_ec">
						        ...
						        <td><%=jjylb.getFundType() %></td>
						        <td><%=jjylb.getRisklevel() %></td>
						        <td><%=jjylb.getShkssjks()>0?jjylb.getShkssjks()+"-":"" %>
						        <%=jjylb.getShkssj()>0?jjylb.getShkssj():"" %></td>
						        <td><%=jjylb.getChargeType()  %></td>
						        <td align="left"><%=jjylb.getGsjc() %></td>
						        <td align="left"><%=jjylb.getXm() %></td>
	...
	<table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
        ...
        <td  align="right"><%=PageUtil.pagination("window.r2Form",totleCount, currentPage, pagesize)%></td>
      </tr>
    </table>
  </div>
...
var _aq = _aq || [];
_aq.push(['_setSiteId', 10001]);_aq.push(['_setCatalogId', 30]); _aq.push(['_trackPageview']); (function() {
