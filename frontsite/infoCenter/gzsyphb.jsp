    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top">
    	 ...
    	 <iframe  onload="frameFitSelfHeight('gz')" width="100%" height="580"  src="${ctx }/zqsyph.do?method=getGzsyphList" frameborder="0" scrolling="no"" marginheight="0" marginwidth="0" id="gz" name="gz" ></iframe>		           
    	</td>
      </tr>
    </table>
  </div>
