...
%>
<body class="body_bg">
<jsp:include page="/share/top.jsp?nav=zxzx&nav1=bg" />
<div class="wjdc_box">
  <p class="wjdc"><a href="/investorEdu/investorSurvey.html"><img src="/pic/index/wzdc.jpg"/></a></p>
</div>
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt; <a  href="/infoCenter/index.jsp?nav=zxzx"> 资讯中心 </a> &gt;  B股</div>
</div>
<div class="wrap_2left">
  ...
  <div class="iptvside_mid">
	  		<jsp:include page="/infoCenter/bstock_lmenu.jsp">
  ...
  <div class="w706 fright">
   ...
   <jsp:include page="/infoCenter/tbbList.jsp">
           <jsp:param name="whichCat" value="<%=whichCat%>"/>
           <jsp:param name="showSize" value="11"/>
