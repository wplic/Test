...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt;<a href="${contextPath }/infoCenter/newStockIndex.jsp?nav=zxzx&nav1=xg&nav2=xgjz"> 新股 </a> &gt; <%=displayName %></div>
</div>
<div class="wrap_2left">
  ...
  <div class="iptvside_mid">
	  <jsp:include page="/infoCenter/newStock_lmenu.jsp" />
<jsp:include page="${ctx }/infoCenter/Search.jsp"/>
  ...
  <div class="w706 fright">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="top">
         <iframe width="100%"  src="${contextPath}/infoCenter/newsStockList.jsp?whichCat=<%=whichCat%>&showSize=18&buttonName=1" frameborder="0" scrolling="no"" marginheight="0" marginwidth="0" id="fundNews" name="fundNews" onload="frameFitSelfHeight('fundNews')"></iframe>
        </td>
      </tr>
    </table>
  </div>
