...
<%@page import="com.cssweb.gazxfund.pojo.FundGsInfo"%><%request.setCharacterEncoding("UTF-8");%>
...
<form action="${contextPath }/fundValueAction.do?method=getOpenFundValueList&nav=zxzx&nav1=jj" name="fundValueForm" method="post">
      								...
      								%>
      									<tr>
									        ...
									        <td><%= fundValue.getLjjz() == null?" ":fundValue.getLjjz() %></td>
									       	<td><%= fundValue.getJjzgm()==null?" ": fundValue.getJjzgm()%></td>
									    </tr>
      								<%
      						}
      						else
