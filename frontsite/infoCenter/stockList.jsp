...
<script type="text/javascript">
	...
	function ggcxListCrm(){
	  ...
	  var url="${contextPath}/infoCenter/stockList.jsp?whichCat=<%=category%>&showSize=<%=showSize1%>&buttonName=<%=buttonNameValue%>&titleWidth=<%=titleWidth%>";
	  if(StartDate!=""){
...
<table width="95%" align="center" class="lh28 font_st">
		<paging:pageRow id="doc" type="com.css.cms.document.Document">
					<%
						...
						if(category.indexOf("zxzx_jysgg_hstbts")>=0||category.indexOf("zxzx_jysgg_sstbts")>=0){
							  detailPage="/cms/CmsnewsContent.jsp?docId="+doc.getId() ;
							  }
					%>
