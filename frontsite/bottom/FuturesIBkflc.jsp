...
<div class="main">
  <div class="dqwz">当前位置：首页 - 期货IB业务 - 交易结果查询方式、投诉及信访方式</div>
</div>
<div class="wrap_2left">
  <!--左侧sied开始-->
  <div class="w210 fleft">
		<jsp:include page="FuturesIB_lmenu.jsp?nav2=kflc" />
  ...
  <div class="w706 fright">
  		<div class="comtit1"><h4>交易结果查询方式、投诉及信访方式</h4>
  		</div>
    <div class="blank10"></div>
    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center"><img src="/pic/futuresIB/img4.jpg"/></td>
      </tr>
...
var _aq = _aq || [];
_aq.push(['_setSiteId', 10001]);_aq.push(['_setCatalogId', 41]); _aq.push(['_trackPageview']); (function() {
