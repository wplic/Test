...
<br/>您目前享受的是 <span class="red"><%=packageName %></span>套餐，您还可以通过升级享受下列更高级别资讯套餐.
  ...
  <div class="p15 lh22">
   ...
   <div class="p15 lh22">
		   您的预受理订单为:<br/>
			...
			document.getElementById('Disp2').innerHTML="<a href='/tcsswebFwcpyslAtion.do?method=getTcsswebFwcpyslListByAccount' target='_blank'>套餐定制情况</a>"; 
			}else if(invp=="9"){
