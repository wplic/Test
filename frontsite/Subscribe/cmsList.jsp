...
<bean:parameter id="productId" name="productId" value="0"/>
<%
	if(category==null){
		%>
...
<table width="95%" align="center"  border="0" cellspacing="0" cellpadding="0" class="lh27 list_bline1">
		<paging:pageRow id="doc" type="com.css.cms.document.Document">
					<%
						i++;
						String detailPage = "/Subscribe/newsContent.jsp?productId="+productId+"&docId="+doc.getId() ;
						  if(category.indexOf("nbzx_jjgs")>=0||category.indexOf("zqyj_yjbg_")==0||category.equals("blcj_nbzx_cyb")||category.equals("blcj_nbzx_gcjcck")||category.equals("blcj_nbzx_sxzqcc")||category.equals("blcj_nbzx_zgsxcj")||category.equals("blcj_nbzx_yjbg")||category.equals("nbzx_xgcjzx") ){
						       detailPage="/cms/gjzxGfyjContent.jsp?productId="+productId+"&docId="+doc.getId() ;
						   }
					%>
					<tr>
					<td width="20" align="center"><img src="/pic/msindex/list_03.gif"/></td>
					<td ><a href="<%=detailPage %>" target="_blank" title="<%=doc.getTitle() %>"><%=DocumentHelper.getTitle(doc,Integer.parseInt(titleWidth))%></a></td>
		            ...
		            <tr>
						...
						<td width="45%" align="right">
								<paging:pageInfo empty="没有记录" />
										...
										<td width="45%" align="right">
								<paging:pageLink hasText="true" hasPageNo="true" mode="text" pages="2" hasGo="false" />
						</td>
					</tr>
		          </table>
</paging:page>
