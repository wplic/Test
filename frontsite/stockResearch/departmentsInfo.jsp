...
<div class="main">
  <div class="dqwz">当前位置：<a href="/default.html">首页</a>  -  <a href="/stockResearch/index.html">证券研究</a> - <a href="/stockResearch/departmentsInfo.html">发展研究中心简介</a> - 部门概况</div>
</div>
<div class="wrap_2left">
  <!--左侧sied开始-->
  <div class="w210 fleft">
		<jsp:include page="/stockResearch/departments_lmenu.jsp?nav2=zqyj_bmgk" />
  </div>
  <!--左侧sied结束-->
   
  <!--中侧sied开始-->
  <div class="w706 fright">
  		<div class="comtit1"><h4>部门概况</h4></div>
    <div class="blank10"></div>
        <table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
            <jsp:include page="${contextPath}/stockResearch/newsIndexList.jsp">
            		<jsp:param name="catName" value="zqyj_bmgk"/>
