...
<%	
		...
		//System.out.println("aaaaaaaaaaaaaaaaaaaaaaaaabbbbbbb");
 %>
<head>
...
<div class="main">
  <div class="dqwz">当前位置：<a href="/default.html">首页</a>  -  <a href="/stockResearch/index.html">证券研究</a> - <a href="/stockResearch/departmentsInfo.html">发展研究中心简介</a> - 销售团队</div>
</div>
<div class="wrap_2left">
  <!--左侧sied开始-->
  <div class="w210 fleft">
		<jsp:include page="/stockResearch/departments_lmenu.jsp?nav2=xstd" />
  </div>
  <!--左侧sied结束-->
   
  <!--中侧sied开始-->
  <div class="w706 fright">
  		<div class="comtit1"><h4>销售团队</h4></div>
