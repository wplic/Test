...
<link href="/css/assetManage/assetManage.css" rel="stylesheet" type="text/css" />
 ...
 if(request.getParameter("zsbh")!=null&&!request.getParameter("zsbh").equals(""))
  list=tcsswebRyxxService.getTcsswebRyxxBySearch_copy("","",request.getParameter("zsbh"));
		...
		<div class="mxjlbox">
		  <table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
			  ...
			  <td width="22%"><img src="${ctx}/branches/showUploadImagez_copy.jsp?zsbh=<%=tcsswebRyxx.getZsbh() %>" width="106" height="146" alt="无"/></td>
			</tr>
		  </table>
		 </div>
	<%}
