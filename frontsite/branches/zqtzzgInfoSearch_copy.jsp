...
<div class="body_bg">
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt; <a href="${contextPath }/branches/index.html">分支机构</a> &gt; 见证开户人员信息查询</div>
	...
	<table border="3" width="100%" align="center" >
	 <tr>
  		<td class="xl64" colspan="5" align="center">
  			 <form action="${contextPath }/mgrInfoAction.do?method=getAllJzryxx" method="post" id="mgrForm" name="mgrForm" onSubmit="return check1();">
		...
		<c:when test="${list!=null }">
			<c:forEach items="${list }" var="exchange">
				<tr class="zgcxContent">
					<td align="center"><a href="#" title="${exchange.ryxm }" onclick="javascript:window.open('${contextPath }/branches/zqtzzgInfo_copy.jsp?zsbh=${exchange.zsbh}','','width=492,height=215,resizable=no,scrollbars=no,menubar=no,location=no,status=yes');"> ${exchange.ryxm }</a></td>
 ...
 <div class="pageBar">
				<form action="/mgrInfoAction.do?method=getAllJzryxx" method="post" id="navigatorForm">
