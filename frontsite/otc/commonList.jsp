...
<%
	...
	if (whichCat.equals("otc_ht")){
		request.setAttribute("otc_title","产品合同");
	}
	if (whichCat.equals("otc_sms")){
		request.setAttribute("otc_title","产品说明书");
	}
...
<div >
<div class="tlbg2">
  	<jsp:include page="aboutList.jsp">
