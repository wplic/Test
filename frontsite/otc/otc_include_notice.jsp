...
<bean:parameter id="category" name="whichCat" value="otc_notice" />

<bean:parameter id="showSize1" name="showSize" value="5" />
...
<table width="95%" align="center"  border="0" cellspacing="0" cellpadding="0" class="lh27 list_bline1">
		<paging:pageRow id="doc" type="com.css.cms.document.Document">
					...
					<td ><a href="<%=detailPage %>" target="_blank" title="<%=totaltitle%>"><%=DocumentHelper.getTitle(doc,15)%></a></td>
