...
<%
	...
	String column="tzzjy_gmxx_dsfcg";
...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt;<a href="${contextPath }/investorEdu/investorSchool.html"> 投资者园地</a> &gt; <a href="${contextPath }/investorEdu/investorSchool.jsp"> 投资教育学院 </a> &gt;第三方存管</div>
</div>
