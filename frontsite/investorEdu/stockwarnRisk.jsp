...
<%
	...
	{
		accounts = qservice.getStockWarn(fund_account, "", "");
	}
...
<script language="javascript">
	...
	function checkreurnf(msg,form){
		...
		if(msg==1){
			...
			form.action="${ctx}/invest/web/StockQuiteAction.go?function=SignAgreement&type=warnRisk&stock_account="+stock_account+"&login_type="+login_type;
			form.submit();
		}else{
...
<script language=JavaScript>
	...
	function OpenDiv(form,status)
	{
		...
		if(chk_pwd == "1")
		{
			form.action="${ctx}/invest/web/StockQuiteAction.go?function=SignAgreement&type=warnRisk&stock_account="+stock_account+"&login_type=3";
			form.submit();
			return;
		}
		}
...
<div class="body_bg">
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt;<a href="${contextPath }/investorEdu/investorSchool.html"> 投资者园地</a> &gt;风险警示股票交易风险揭示书</div>
</div>
...
<table width="95%" style="border-collapse:collapse" border="1" bgcolor="#ffffff" bordercolor="#cfcfcf" class="lh21 mt5" align="center">
  ...
  <div class="left_tit2">风险警示股票交易风险揭示书</div>
    <div class="blank10"></div>
    <p align="center" class="font14 bold mtb16">风险警示股票交易风险揭示书</p>
    <div class="lh21 p10">
      <p>尊敬的投资者：</p>
      <p>　　为强化对参与风险警示股票交易投资者的风险警示，保护投资者的合法权益，保障上市公司退市制度的平稳实施，根据上海、深圳证券交易所《股票上市规则》、《会员管理规则》及相关规定，本公司特制定《风险警示股票交易风险揭示书》，向您充分揭示参与风险警示股票交易面临的风险如下：<br/>
	     	 　　一、投资者在参与风险警示股票交易前，应充分了解投资者买卖风险警示股票应当采用限价委托的方式。<br/>
	     	 　　二、投资者在参与风险警示股票交易前，应充分了解风险警示股票价格的涨跌幅限制与其他股票的涨跌幅限制不同。<br/>
			　　三、风险警示股票盘中换手率达到或超过一定比例的，属于异常波动，交易所可以根据市场需要，对其实施盘中临时停牌。<br/>
			　　四、单一账户当日累计买入的单只风险警示股票，数量不得超过50 万股。<br/>
			　　五、投资者在参与风险警示股票交易前，应充分了解风险警示股票交易规定和相关上市公司的基本面情况，并根据自身财务状况、实际需求及风险承受能力等，审慎考虑是否买入风险警示股票。<br/>
			　　六、投资者应当特别关注上市公司发布的风险提示性公告，及时从指定信息披露媒体、上市公司网站以及证券公司网站等渠道获取相关信息。<br/>
    ...
    <p class="p15 lh21"> 　特别提醒：本《风险揭示书》的提示事项仅为列举性质，未能详尽列明风险警示股票交易的所有风险。本公司再次提醒您审慎参与风险警示股票交易。
投资有风险，入市需谨慎！</p>
 <div class="risytit">投资者声明及签字</div>
    <p class="p15 lh21"> 　投资者声明及签字：本人/机构已详细阅读并完全理解了本《风险警示股票交易风险揭示书》的各项内容，愿意承担风险警示股票交易的风险和损失。</p>
    ...
    <div>
     <%
		...
		else if(StringHelper.isEmpty(accounts))
		{
            ...
            <tr>
              <td width="43" height="21"><img src="${ctx}/investorEdu/images/adv.jpg" width="43" height="29" /></td>
              <td  style=" font-size:14px;,font-family: Arial, Helvetica, sans-serif">您没有尚未签署的风险警示的股东账户</td>
            </tr>
          </table>
          </div>
			<%
		...
		else
		{
			...
			%>
			<div class="risytitgdk">尚未签署风险警示的股东卡</div>
			...
			%>
				<div class=" blank10"></div>
   				<div align="center"><input id="btn_login" name="btn_login" type="button" class="bottom"  onclick="OpenDiv(this.form,'submit')" style="cursor:pointer" value="同意签署"/></div>
			<%
		}
    %>
    </div>
		...
		<div id="Loading"  style="display: none; "  >
		  <table width="100%" border="0" cellpadding="0"
				...
				<tr>
					...
					<input type="button" onclick="checkLogin(this.form)" class="bottom" style="cursor:pointer" value="确  定"/>
					</td></tr>
					</table>
