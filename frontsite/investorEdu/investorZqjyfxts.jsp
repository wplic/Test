...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt;<a href="${contextPath }/investorEdu/investorSchool.html"> 投资者园地</a> &gt; <a href="${contextPath }/investorEdu/investorRisk.jsp"> 风险教育 </a> &gt; 证券交易风险提示</div>
</div>
<div class="wrap_2left">
  ...
  <div class="iptvside_mid">
	  <jsp:include page="${contextPath}/investorEdu/investorRisk_lmenu.jsp" />
  ...
  <div class="left_tit2">证券交易风险提示</div> 
