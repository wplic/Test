...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt;<a href="${contextPath }/investorEdu/investorSchool.html"> 投资者园地</a> &gt; <a href="${contextPath }/investorEdu/investorSchool.jsp"> 投资教育学院 </a> &gt; 基金知识</div>
</div>
<div class="wrap_2left">
  ...
  <div class="left_tit2">基金知识</div> 
    <div class="blank10"></div>
    		    ...
    		    <jsp:include page="${contextPath }/investorEdu/investorStocklist.jsp?state=1&whichCat=zxzx_jj_jjzs&is_delete=0"></jsp:include>
  </div>
  <!--右侧sied结束--> 
