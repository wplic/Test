...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt;<a href="${contextPath }/investorEdu/investorSchool.html"> 投资者园地</a> &gt;<a href="${contextPath }/investorEdu/investorBaseStock.jsp?nav=tzzyd&nav1=spjy1&nav2=gpsrx">视频教育</a> &gt; 广发教育视频</div>
</div>
<div class="wrap_2left">
  ...
  <div class="left_tit2">风险教育视频</div> 
    ...
    <div id="spjy"><span class="smwz red"><a href="${ctx}/tvideo.do?method=getTpSearchResultByParam&category=<%=code %>&nav=<%=nav %>&nav1=<%=nav1 %>&nav2=<%=nav2 %>&nav3=<%=nav3 %>">更多>></a></span>更多视频</div>
