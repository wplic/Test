...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/index.jsp?nav=index">首页</a> &gt;<a href="${contextPath }/investorEdu/investorSchool.html"> 投资者园地</a> &gt; <a href="${contextPath }/investorEdu/investorSchool.jsp"> 投资教育学院 </a> &gt; 技术分析 </div>
</div>
<div class="wrap_2left">
  ...
  <div class="iptvside_mid">
	  <jsp:include page="${contextPath}/investorEdu/investorTzjyt_lmenu.jsp?nav2=jsfx" />
