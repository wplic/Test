...
<script>
	...
	{					
		for(var rc=1;rc<=num;rc++)
		{									
			var tagrc=document.getElementById("tag"+ name + rc).className;
			if(tagrc==class1){
				document.getElementById("tag"+ name + rc).className=class2; 
			}
		}
	}
...
<div class="main">
  <div class="dqwz">当前位置：<a href="/default.html">首页 </a> - <a href="${contextPath }/job/index.html">人才招聘</a> - 社会招聘</div>
</div>
...
<div class="comtit1"><h4>社会招聘</h4></div>
<div class="blank10"></div>
<div class="line28 pl15 w96"><ul class="rrqh">
<li class="rrqh_down red" id="tagtabsrc01" onmouseover="SwitchNewsRczp('tabsrc0', 1, 3,'rrqh_down red','font_73');changeIframe(1,1,'noCat');"><a href="javascript:void(0)">总部招聘</a></li>
<li class="font_73" id="tagtabsrc02" onmouseover="SwitchNewsRczp('tabsrc0', 2, 3,'rrqh_down red','font_73');changeIframe(1,2,'noCat');"><a href="javascript:void(0)">分支机构招聘</a></li>
<li class="font_73" id="tagtabsrc03" onmouseover="SwitchNewsRczp('tabsrc0', 3, 3,'rrqh_down red','font_73');changeIframe('rczp_shzp',1,'Cat');"><a href="javascript:void(0)">社会招聘情况说明</a></li>
</ul>
</div><div class="blank10"></div>
 <iframe id="jobiframe" name="" src="${ctx }/thrPostInfoAction.do?method=getList&cat=1&type=1" frameborder="0" marginheight="0" marginwidth="0" onload="iframeFitHeight(this)" width="100%" scrolling="no">
 </iframe>
