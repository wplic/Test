...
<div class="main">
  <div class="dqwz">当前位置：<a href="/default.html">首页 </a> - <a href="${contextPath }/job/index.html">人才招聘</a> - 见习生招聘</div>
</div>
<div class="wrap_2left">
  <!--左侧sied开始-->
  <div class="w210 fleft">
		<jsp:include page="/job/job_lmenu.jsp?nav=sxszp" />
...
<div class="comtit1"><h4>见习生招聘</h4></div>
<div class="blank10"></div>
<div class="line28 pl15 w96"><ul class="rrqh">
<li class="rrqh_down red" id="tagtabs01" onmouseover="SwitchNews('tabs0', 1, 3,'rrqh_down red','font_73');changeIframe(3,1,'noCat');"><a href="javascript:void(0)">总部招聘</a></li>
<li class="font_73" id="tagtabs02" onmouseover="SwitchNews('tabs0', 2, 3,'rrqh_down red','font_73');changeIframe(3,2,'noCat');"><a href="javascript:void(0)">分支机构招聘</a></li>
<li class="font_73" id="tagtabs03" onmouseover="SwitchNews('tabs0', 3, 3,'rrqh_down red','font_73');changeIframe('rczp_sxszp',1,'Cat');"><a href="javascript:void(0)">见习生招聘情况说明</a></li>
</ul>
</div><div class="blank10"></div>
 <iframe id="jobiframe" name="" src="${ctx }/thrPostInfoAction.do?method=getList&cat=3&type=1" frameborder="0" marginheight="0" marginwidth="0" onload="this.height =document.frames['jobiframe'].document.body.scrollHeight" width="100%" scrolling="no">
 </iframe>
