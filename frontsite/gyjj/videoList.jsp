...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="layout">
  <tr>
    ...
    <div class="navLeft">
      ...
      <li class="this"><a href="${contextPath }/gyjj/videoList.jsp?themeid=<%=themeid%>">专题视频</a></li>
    ...
    <div class="columnOut">
      <div class="columnTitle"><h3>专题视频</h3></div>
      <div class="columnMain">
       ...
       <li>
        	<a href="${ctx }/gyjj/videoShow.jsp?themeid=<%=themeid%>&videoid=<%=video.getId()%>">
