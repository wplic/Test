...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="layout">
  <tr>
    ...
    <div class="navLeft">
      ...
      <li><a href="${contextPath }/gyjj/news.jsp">新闻动态</a></li>
      <li><a href="${contextPath }/gyjj/newxmzt.jsp">项目专题</a></li>
      <li class="this"><a href="${contextPath }/gyjj/newtggg.jsp">通知公告</a></li>
    </ul>
    </div>
    </th>
    <td valign="top" class="wrapright">
      <div class="columnOut">
      <div class="columnTitle"><h3>通知公告</h3><span><b>首页</b>><b>基金会动态 </b>><strong>通知公告</strong></span></div>
      <div class="columnMain system">
      <jsp:include page="/gyjj/project_download_list.jsp">
				<jsp:param value="gyjj_tggg" name="whichCat"/>
