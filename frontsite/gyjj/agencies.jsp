...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="layout">
  <tr>
    ...
    <div class="navLeft">
      ...
      <li class="this"><a href="agencies.jsp">机构设置</a></li>
    ...
    <td valign="top" class="wrapright">
      <div class="columnOut">
      <div class="columnTitle"><h3>机构设置</h3><span><b>首页</b>><b>基金会简介</b>><strong>机构设置</strong></span></div>
      <div class="columnMain system">
      <table>
         <jsp:include page="/stockResearch/newsIndexList.jsp">
            		<jsp:param name="catName" value="gyjj_jgsz"/>
