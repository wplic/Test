...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="layout">
  <tr>
    ...
    <div class="navLeft">
      ...
      <li class="this"><a href="${contextPath }/gyjj/topicspicList.jsp?themeid=<%=themeid%>">专题图片</a></li>
    </ul>
    </div>
    </th>
    <td valign="top" class="wrapright">
    <div class="columnOut">
      <div class="columnTitle"><h3>专题图片</h3></div>
      <div class="columnMain">
        ...
        <li>
        	<a href="${ctx}/gyjj/topicsShow.jsp?themeid=<%=themeid%>&picid=<%=pic.getId()%>">
        		<img src="${ctx}/share/showUploadImage.jsp?id=<%=pic.getPicid()%>" width="100" height="90" />
        		<span title="<%=pic.getTitle() %>">
