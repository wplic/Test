...
<body>
<!-- header begin -->
<jsp:include page="/gyjj/index_top.jsp?nav=jjhdt" />
<!-- header end -->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="layout">
  <tr>
    ...
    <div class="navLeft">
      <h3><img src="${contextPath }/gyjj/images/title_jjdt.jpg" /></h3>
      <ul class="navleftList">
      <li class="this"><a href="${contextPath }/gyjj/news.jsp">新闻动态</a></li>
      <li><a href="${contextPath }/gyjj/newxmzt.jsp">项目专题</a></li>
      <li><a href="${contextPath }/gyjj/newtggg.jsp">通知公告</a></li>
    </ul>
    </div>
    </th>
    <td valign="top" class="wrapright">
      <div class="columnOut">
      <div class="columnTitle"><h3>新闻动态</h3><span><b>首页</b>><b>基金会动态 </b>><strong>新闻动态</strong></span></div>
      <jsp:include page="/gyjj/gyjjListpage.jsp">
				<jsp:param value="gyjj_jjhdt" name="whichCat"/>
