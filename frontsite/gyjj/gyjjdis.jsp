...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="layout">
  <tr>
    ...
    <div class="navLeft">
      ...
      <li><a href="institutionLists.jsp">管理制度</a></li>
      <li><a href="agencies.jsp">机构设置</a></li>
      <li class="this"><a href="gyjjdis.jsp">基金会大事记</a></li>
    </ul>
    </div>
    </th>
    <td valign="top" class="wrapright">
      <div class="columnOut">
      <div class="columnTitle"><h3>基金会大事记</h3><span><b>首页</b>><b>基金会简介</b>><strong>基金会大事记</strong></span></div>
