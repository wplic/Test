...
<div class="main">
  <div class="dqwz">当前位置：<a href="/default.html">首页</a> - <a href="/investorNexus/index.html">投资者关系</a> - 公司概要</div>
</div>
<div class="wrap_3c">
  <!--左侧sied开始-->
    ...
    <table width="100%" align="center" border="0" cellspacing="0" cellpadding="0" >
      <tr>
        ...
        <jsp:include page="${ctx }/job/jobContent.jsp">
          		<jsp:param name="whichCat" value="tzzgx_gsky"/>
          </jsp:include>
        </td>
      </tr>
    </table>
