...
<body>
 <jsp:include page="/commons/mstop.jsp" />
  <div class="main">
    <div class="dqwz">当前位置：<a href="/default.html">首页</a> - <a href="/investorNexus/index.html">投资者关系</a> - 投资者互动平台</div>
</div>
<form action="${contextPath }/financeMsgAction.do?method=saveFinanceMsg&ext3=3" name="financeForm" id="financeForm" method="post" >
...
<div class="mobox">
  ...
  <div class="moleft">
  		<jsp:include page="/investorNexus/index_lmenu.jsp?nav=tzfdpt" />
  </div>
  
<form action="${contextPath }/financeMsgAction.do?method=getFinanceMessageList&ext3=3" name="msgForm" method="post">
<div class="moright">
        <div class="blank10"></div>
		<div class="rtit2">投资者互动平台</div>
		<div class="zx_search">
...
<script language="javascript">
	...
	function refreshCaptcha(){
            ...
            var url="${contextPath }/financeMsgAction.do?method=getFinanceMessageList&ext3=3";
            if(msg!="")
			   {
