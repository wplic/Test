  ...
  <div class="w492 fleft mlr4">
    ...
    <table width="100%" align="center">
      <tr>
        ...
        <td class="jhlctit2 "><a href="specialFinancial.jsp">情况简介</a><span class="font_8c"> |&nbsp; </span><a href="salesAgencies.jsp">销售机构</a> <span class="font_8c">| &nbsp;</span><a href="speciaAffiche.jsp">专项公告</a><span class="font_8c"> |&nbsp;</span> <a href="speciaLawFile.jsp" class="red">法律文件</a><span class="font_8c"> |&nbsp;</span> <a href="specialContactUs.jsp">联系我们</a></td>
        <td class="jhlctit3">&nbsp;</td>
      </tr>
    </table>
    <div class="blank10"></div>
  	 <iframe width="100%"  src="${contextPath}/assetManage/assetlist.jsp?whichCat=tzlc_zxlc_flwj&showSize=50&buttonName=1" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" id="fundNews" name="fundNews" onload="frameFitSelfHeight('fundNews')"></iframe>
