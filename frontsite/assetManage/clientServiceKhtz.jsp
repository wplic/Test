...
<div class="main">
  <div class="dqwz">当前位置：<a href="${contextPath }/default.html"> 首页 </a>-<a href="${contextPath }/assetManage/index.jsp">资产管理</a> - 客户服务 - 文件查询及账户通知</div>
</div>
<form name="qForm" id="qForm" action="${contextPath}/tclientYdbgAction.do?method=getClientServiceMap" method="post">
<div class="wrap_2left">
  <!--左侧sied开始-->
  <div class="w210 fleft">
	 <jsp:include page="clientService_lmenu.jsp?nav=khtz" />
  </div>
  <!--左侧sied结束-->
   
  <!--中侧sied开始-->
  <div class="w706 fright">
  <div class="comtit1"><h4>文件查询及帐户通知</h4>
  </div>
  <div class="blank10"></div>
  <div class="khfwtit1"><span class="font14">文件查询及帐户通知</span> </div>
  <div class="blank10"></div>
	  ...
	  <%
	 		if (list != null && list.size() > 0)
	 		{
	 				for (int i = 0 ; i < list.size() ; i ++)
	 				{
	 						...
	 						%>
	 							<tr align="center">    
									<td width="70%" align="left"><a href="${contextPath}/assetManage/infokhtzList.jsp?ydbgId=<%=tclientYdbg.getId() %>" target="_blank" title=""><%=tclientYdbg.getTitle() %></a></td>
