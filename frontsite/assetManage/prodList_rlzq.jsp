...
<form action="${contextPath }/prod/productAction.do?method=getProductNetValuetList_rlfj1" method="post" id="corpForm" name="form1">
          ...
          <td width="19%" valign="top"><p align="center">单位净值</p></td>
			...
			%>
              <tr>
                ...
                <%if(map.get("product_code").equals("870012")){ %>
                	<td width="19%" valign="top"><p align="center">睿利债券1号</p></td>
                <%} %>
                <%if(map.get("product_code").equals("870013")){ %>
                	<td width="19%" valign="top"><p align="center">睿利债券1号优先</p></td>
                <%} %>
                <%if(map.get("product_code").equals("870014")){ %>
                	<td width="19%" valign="top"><p align="center">睿利债券1号进取</p></td>
                <%} %>
