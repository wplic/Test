...
<%@page import="java.util.Map"%><%request.setCharacterEncoding("UTF-8");%>
...
<form action="${contextPath }/prod/productAction.do?method=getProductNetValuetList_gkgg_f" method="post" id="corpForm" name="form1">
	...
	<table border="1" bordercolor="#cccccc" width="98%" align="center" class="lh24 mt10">
          ...
          <td width="19%" valign="top"><p align="center">每万份份额收益（元）</p></td>
          <td width="19%" valign="top"><p align="center">七日年化收益率（%）</p></td>
              </tr>	
			...
			%>
              <tr>
                <td width="19%" valign="top"><p align="center"><%=map.get("net_value_date") %></p></td>
                <td width="19%" valign="top"><p align="center"><%=map.get("mwfsy") %></p></td>
                <td width="19%" valign="top"><p align="center"><%=map.get("nhsyl") %></p></td>
              </tr>
            <%} }%>  
    </table>  
