...
<div class="wrap_2left">
  ...
  <div class="w706 fright">
   ...
   <iframe width="100%"  src="${contextPath }/question.do?method=getAssetQuestionList&assetProd=<%=assetProd %>" frameborder="0" scrolling="no"" marginheight="0" marginwidth="0" id="qzz" name="qzz" onload="frameFitSelfHeight('qzz')"></iframe>		
  </div>
  <!--右侧sied结束--> 
