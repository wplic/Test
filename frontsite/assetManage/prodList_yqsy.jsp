...
<form action="${contextPath }/prod/productAction.do?method=getProductNetValuetList_yqsy&assetProd=${assetProd }" method="post" id="corpForm" name="form1">
	...
	<table border="1" bordercolor="#cccccc" width="98%" align="center" class="lh24 mt10">
          ...
          <td width="19%" valign="top"><p align="center">预期年化收益率 </p></td>
              </tr>	
