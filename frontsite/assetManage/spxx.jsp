...
<div class="wrap_2left">
  ...
  <div class="w210 fleft">
	 <jsp:include page="${contextPath }/assetManage/assetInfo_index_lmenu.jsp?nav=spxx&nav1=spxx" />
  </div>
  <!--左侧sied结束-->
   
  <!--右侧sied开始-->
  <div class="w706 fright">
  <div class="left_tit2">视频学习</div> 
    ...
    <div id="spjy"><span class="smwz red"><a href="${ctx}/tvideo.do?method=getSpxxByParam&category=<%=code %>">更多>></a></span>更多视频</div>
    ...
    %>
    	...
    	<div id="spjy_box2">
    	<%} %>
    	<span <%=(j+1)%5==0?"":"class='mr26'" %>><a href="${ctx}/assetManage/SpxxObject.jsp?id=<%=pro.getId()%>" target="_blank">
    		<%if(pro.getPicId()>0){ %>
