...
<jsp:include page="/commons/mstop.jsp" />
  <form action="${contextPath }/tradelogAction.do?method=getTradeLog&menu=ywbgxx" name="tradelogForm" method="post">
<div class="main">
...
<div class="wrap_2left">
  ...
  <div class="w210 fleft">
	 <jsp:include page="${contextPath}/assetManage/collectService_lmenu.jsp?menu=ywbgxx" />
  </div>
  <!--左侧sied结束-->
      					...
      					for (int i = 0; i < list.size() ; i ++)
      					{
      							...
      							if (i % 2 ==0 )
      							{
      									%>
											        ...
											        <td align="center"><%= tradelog.getConfirmedamount().doubleValue()==0.0?" ":f.format(tradelog.getConfirmedamount())%></td>
											      </tr>
      									<%
      							}
      							else
